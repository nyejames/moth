...
- [AUD-0002-F02: `fork_for_module` is called per module inside the discovery loop, copying the whole string table once per module against its own API guidance](./audits/AUD-0002-stage0-discovery-preparation-performance.md#aud-0002-f02-fork_for_module-is-called-per-module-inside-the-discovery-loop-copying-the-whole-string-table-once-per-module-against-its-own-api-guidance)
