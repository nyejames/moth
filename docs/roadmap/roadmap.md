...
- [Post-Phase-3 compiler cleanup](./plans/moth-post-phase-3-tidy-up-plan.md). Complete this separate maintainer-selected checkpoint after the accepted Phase 3 merge and before the MON syntax cutover.
