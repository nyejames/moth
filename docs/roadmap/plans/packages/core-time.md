...
package lane paused under the roadmap order until MON syntax, MON Rust tooling, Wiring V1 and
native result-slot/Core const-eval checkpoints land. Data-layout Phase 3 closeout
