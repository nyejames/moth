...
NEXT_ACTION: publish the rebased feature branch with exact force-with-lease; do not squash merge
...
```text
REVISION: final closeout validation checkpoint
...
NEXT_EXACT_SLICE: publish the rebased feature branch without a merge or squash
```
