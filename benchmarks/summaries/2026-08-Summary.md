...
Change since initial benchmark: baseline
Initial: all ~16ms, Core ~16ms, Docs ~187ms, Stress ~9ms, Module ~9ms, Borrow ~6ms
Latest: all ~16ms, Core ~16ms, Docs ~187ms, Stress ~9ms, Module ~9ms, Borrow ~6ms
Case spread latest: ~33ms
---------------------
