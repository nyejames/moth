...
- [builder boundary above frontend](src/build_system/): kw — config, modules, artifacts, cleanup.
    ...
    - [create_project_modules](src/build_system/create_project_modules/): Stage 0 module/source discovery.
        ...
        - [source_tree_index.rs](src/build_system/create_project_modules/source_tree_index.rs), [module_identity.rs](src/build_system/create_project_modules/module_identity.rs), [project_module_graph.rs](src/build_system/create_project_modules/project_module_graph.rs): one canonical source traversal, stable supported-source inventory, nearest-module owned source sets, deterministic dense module assignment, structural ancestry, scoped support visibility and dependency-ordered compile waves.
...
- [defined_public_type_surface.rs](src/compiler_frontend/defined_public_type_surface.rs): total direct-declaration projection from AST-owned roots into canonical function, nominal, alias, constant and receiver type surfaces, including owned callable and struct defaults.
...
- [public_interface_draft.rs](src/compiler_frontend/public_interface_draft.rs): declaration-centric aggregate pre-HIR public-semantic draft builder that consumes direct origin, type, folded-value and trait projections.
