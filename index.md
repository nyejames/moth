...
- [module_compilation](src/compiler_frontend/module_compilation/): compiler-owned module compilation boundary — [options.rs](src/compiler_frontend/module_compilation/options.rs) frontend options, [prepared.rs](src/compiler_frontend/module_compilation/prepared.rs) provider-independent prepared input, [artefact.rs](src/compiler_frontend/module_compilation/artefact.rs) `Module` executable/link-fact/compiler-metadata lanes and `CompiledModuleArtifact`, [generated.rs](src/compiler_frontend/module_compilation/generated.rs) sidecars and the per-transaction generated delta, [outcome.rs](src/compiler_frontend/module_compilation/outcome.rs) success/diagnosed classification. kw: FrontendOptions, PreparedModuleInput, ModuleSemanticResult.
