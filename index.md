...
- [builder boundary above frontend](src/build_system/): kw — config, modules, artifacts, cleanup.
    ...
    - [create_project_modules](src/build_system/create_project_modules/): Stage 0 module/source discovery.
        - [frontend_orchestration.rs](src/build_system/create_project_modules/frontend_orchestration.rs): per-module frontend pipeline and generated-request materialisation orchestration.
        - [generated_worklist.rs](src/build_system/create_project_modules/generated_worklist.rs): boundary-local generated request state, completed sidecars and publication deltas.
        - [generated_summary_convergence.rs](src/build_system/create_project_modules/generated_summary_convergence.rs): transient HIR call topology, dirty-queue scheduling and exact summary convergence.
        - [module_inventory.rs](src/build_system/create_project_modules/module_inventory.rs), [source_discovery.rs](src/build_system/create_project_modules/source_discovery.rs), [source_scanning.rs](src/build_system/create_project_modules/source_scanning.rs), [prepared_source.rs](src/build_system/create_project_modules/prepared_source.rs), [prepared_module.rs](src/build_system/create_project_modules/prepared_module.rs): direct owned-`SourceId` loading, synthetic single-file traversal and lexical/import extraction, the transient source-kind handoff consumed by frontend preparation, and retained module syntax.
