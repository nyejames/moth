...
#[test]
fn integer_division_binop_emits_zero_checked_truncation_path() {  let mut path_fork = PathInternerFork::empty(); let mut string_table = StringTable::new(); let (type_environment, types) = build_type_environment();
...
#[test]
fn explicit_copy_emits_clone_value_wrapped_read() {  let mut path_fork = PathInternerFork::empty(); let mut string_table = StringTable::new(); let (type_environment, types) = build_type_environment();
...
#[test]
fn lowers_option_construct_expression() {  let mut path_fork = PathInternerFork::empty(); let mut string_table = StringTable::new(); let (type_environment, types) = build_type_environment();
...
let module = build_module(&mut path_fork, &mut string_table, "main", vec![block], function, &[]);
...
#[test]
fn growable_collection_expression_lowers_to_array() {  let mut path_fork = PathInternerFork::empty(); let mut string_table = StringTable::new(); let (mut type_environment, types) = build_type_environment();
...
#[test]
fn fixed_collection_expression_lowers_to_wrapper() {  let mut path_fork = PathInternerFork::empty(); let mut string_table = StringTable::new(); let (mut type_environment, types) = build_type_environment();
...
#[test]
fn fixed_collection_empty_expression_lowers_to_wrapper() {  let mut path_fork = PathInternerFork::empty(); let mut string_table = StringTable::new(); let (mut type_environment, types) = build_type_environment();
...
#[test]
fn map_literal_with_entries_lowers_to_map_new() {  let mut path_fork = PathInternerFork::empty(); let mut string_table = StringTable::new(); let (type_environment, types) = build_type_environment();
...
#[test]
fn empty_map_literal_lowers_to_map_new_with_empty_array() {  let mut path_fork = PathInternerFork::empty(); let mut string_table = StringTable::new(); let (type_environment, types) = build_type_environment();
...
#[test]
fn lowers_structural_string_with_url_map_as_escaped_literal() {  let mut path_fork = PathInternerFork::empty(); let mut string_table = StringTable::new(); let (type_environment, types) = build_type_environment();
let region = RegionId(0);
