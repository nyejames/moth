...
#[test]
fn emits_structured_if_without_dispatcher() {  let mut path_fork = PathInternerFork::empty(); let mut string_table = StringTable::new(); let (type_environment, types) = build_type_environment();
...
#[test]
fn emits_structured_match_without_inlining_synthetic_merge_arm() {  let mut path_fork = PathInternerFork::empty(); let mut string_table = StringTable::new(); let (type_environment, types) = build_type_environment();
...
#[test]
fn literal_match_uses_structured_lowering_when_cfg_is_acyclic() {  let mut path_fork = PathInternerFork::empty(); let mut string_table = StringTable::new(); let (type_environment, types) = build_type_environment();
...
#[test]
fn option_present_match_checks_some_tag_without_payload_comparison() {  let mut path_fork = PathInternerFork::empty(); let mut string_table = StringTable::new(); let (type_environment, types) = build_type_environment();
...
#[test]
fn literal_match_uses_dispatcher_when_cfg_contains_cycle() {  let mut path_fork = PathInternerFork::empty(); let mut string_table = StringTable::new(); let (type_environment, types) = build_type_environment();
...
#[test]
fn structured_match_merge_convergence_lowers_jump_arguments() {  let mut path_fork = PathInternerFork::empty(); let mut string_table = StringTable::new(); let (type_environment, types) = build_type_environment();
...
#[test]
fn dispatcher_match_merge_convergence_lowers_jump_arguments() {  let mut path_fork = PathInternerFork::empty(); let mut string_table = StringTable::new(); let (type_environment, types) = build_type_environment();
...
#[test]
fn match_guard_condition_emits_pattern_and_guard_conjunction() {  let mut path_fork = PathInternerFork::empty(); let mut string_table = StringTable::new(); let (type_environment, types) = build_type_environment();
...
#[test]
fn dispatcher_match_without_selected_arm_emits_no_arm_selected_fallback() {  let mut path_fork = PathInternerFork::empty(); let mut string_table = StringTable::new(); let (type_environment, types) = build_type_environment();
...
#[test]
fn falls_back_to_dispatcher_for_cfg_cycle() {  let mut path_fork = PathInternerFork::empty(); let mut string_table = StringTable::new(); let (type_environment, types) = build_type_environment();
...
#[test]
fn lowers_break_and_continue_terminators_with_dispatcher() {  let mut path_fork = PathInternerFork::empty(); let mut string_table = StringTable::new(); let (type_environment, types) = build_type_environment();
...
let module = build_module(&mut path_fork, &mut string_table, "main", blocks, function, &[]);
...
#[test]
fn jump_args_lower_block_to_block_value_transfer() {  let mut path_fork = PathInternerFork::empty(); let mut string_table = StringTable::new(); let (type_environment, types) = build_type_environment();
...
#[test]
fn structured_branch_merge_lowers_jump_arguments() {  let mut path_fork = PathInternerFork::empty(); let mut string_table = StringTable::new(); let (type_environment, types) = build_type_environment();
...
#[test]
fn dispatcher_loop_back_edge_lowers_jump_arguments() {  let mut path_fork = PathInternerFork::empty(); let mut string_table = StringTable::new(); let (type_environment, types) = build_type_environment();
...
#[test]
fn jump_args_write_through_alias_only_target_local() {  let mut path_fork = PathInternerFork::empty(); let mut string_table = StringTable::new(); let (type_environment, types) = build_type_environment();
...
#[test]
fn dispatcher_with_fallible_return_wraps_dispatcher_in_try_catch() {  let mut path_fork = PathInternerFork::empty(); let mut string_table = StringTable::new(); let (mut type_environment, types) = build_type_environment();
...
#[test]
fn multiple_acyclic_if_blocks_stay_structured() {  let mut path_fork = PathInternerFork::empty(); let mut string_table = StringTable::new(); let (type_environment, types) = build_type_environment();
