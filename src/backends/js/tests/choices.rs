...
#[test]
fn choice_variant_construction_emits_tagged_carrier() {  let mut path_fork = PathInternerFork::empty(); let mut string_table = StringTable::new(); let (type_environment, types) = build_type_environment();
...
#[test]
fn choice_match_lowers_to_structured_if_with_choice_tags() {  let mut path_fork = PathInternerFork::empty(); let mut string_table = StringTable::new(); let (type_environment, types) = build_type_environment();
...
#[test]
fn choice_match_with_wildcard_arm_emits_true_condition() {  let mut path_fork = PathInternerFork::empty(); let mut string_table = StringTable::new(); let (type_environment, types) = build_type_environment();
...
#[test]
fn relational_match_patterns_emit_correct_js_operators() {  let mut path_fork = PathInternerFork::empty(); let mut string_table = StringTable::new(); let (type_environment, types) = build_type_environment();
