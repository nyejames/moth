...
use super::frozen_syntax::{StableBodySyntax, stable_path};
...
pub(crate) struct ModuleMaterialisationPreparation {
    ...
    pub(super) default_const_templates_by_path: FxHashMap<InternedPath, PublicConstTemplate>,
    ...
    pub(super) generic_template_paths_by_identity:
        FxHashMap<GeneratedDeclarationIdentity, InternedPath>,
    ...
    pub(super) source_nominal_paths: FxHashSet<InternedPath>,
    pub(super) public_trait_paths: Vec<InternedPath>,
