...
pub(crate) use diagnostic_payload::{
    ...
    DeferredFeatureReason, DiagnosticCompoundAssignmentOperator, DiagnosticOperator,
    ...
    InvalidFallibleHandlingReason, InvalidFallibleOperandReason, InvalidFieldAccessReason,
