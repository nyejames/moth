...
#[test]
fn checked_int_addition_lowers_to_int_add_numeric_op() { let mut path_fork = super::PathInternerFork::empty(); let mut string_table = StringTable::new();
let loc = None;
...
#[test]
fn checked_int_subtraction_lowers_to_int_sub_numeric_op() { let mut path_fork = super::PathInternerFork::empty(); let mut string_table = StringTable::new();
let loc = None;
let expr = runtime_expr(
    vec![
...
#[test]
fn checked_regular_division_lowers_to_float_div_numeric_op() { let mut path_fork = super::PathInternerFork::empty(); let mut string_table = StringTable::new();
let loc = None;
let expr = runtime_expr(
    vec![
        runtime_operand_item(int_expr(5, loc)),
...
#[test]
fn mixed_int_float_addition_converts_int_operand() { let mut path_fork = super::PathInternerFork::empty(); let mut string_table = StringTable::new();
let loc = None;
let expr = runtime_expr(
    vec![
...
#[test]
fn unary_int_negation_lowers_to_int_neg_numeric_op() { let mut path_fork = super::PathInternerFork::empty(); let mut string_table = StringTable::new();
let loc = None;
let x_name = symbol("x", &mut path_fork, &mut string_table);
let x_ref = reference_expr_with_type_id(
    x_name.clone(),
...
#[test]
fn numeric_failure_mode_is_return_error_for_builtin_error_function() { let mut path_fork = super::PathInternerFork::empty(); let mut string_table = StringTable::new();
let loc = None;
...
#[test]
fn numeric_failure_mode_is_trap_for_custom_error_function() { let mut path_fork = super::PathInternerFork::empty(); let mut string_table = StringTable::new();
let loc = None;
...
#[test]
fn numeric_failure_mode_is_trap_for_non_fallible_function() { let mut path_fork = super::PathInternerFork::empty(); let mut string_table = StringTable::new();
let loc = None;
