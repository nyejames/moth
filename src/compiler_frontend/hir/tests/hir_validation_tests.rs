...
#[test]
fn valid_module_passes_explicit_validation() { let mut path_fork = super::PathInternerFork::empty(); let mut string_table = StringTable::new();
let (entry_path, start_name) = super::entry_path_and_start_name(&mut path_fork, &mut string_table);
...
fn inject_float_statement(module: &mut HirModule,
...
#[test]
fn validator_rejects_invalid_jump_target() { let mut path_fork = super::PathInternerFork::empty(); let mut string_table = StringTable::new();
let (entry_path, start_name) = super::entry_path_and_start_name(&mut path_fork, &mut string_table);
...
#[test]
fn validator_rejects_non_literal_match_pattern() { let mut path_fork = super::PathInternerFork::empty(); let mut string_table = StringTable::new();
let (entry_path, start_name) = super::entry_path_and_start_name(&mut path_fork, &mut string_table);
...
#[test]
fn validator_rejects_missing_side_table_mappings() { let mut path_fork = super::PathInternerFork::empty(); let mut string_table = StringTable::new();
let (entry_path, start_name) = super::entry_path_and_start_name(&mut path_fork, &mut string_table);
let x = super::symbol("x", &mut path_fork, &mut string_table);
...
#[test]
fn validator_rejects_unresolved_generic_parameter_types() { let mut path_fork = super::PathInternerFork::empty(); let mut string_table = StringTable::new();
let (entry_path, start_name) = super::entry_path_and_start_name(&mut path_fork, &mut string_table);
...
#[test]
fn validator_rejects_struct_field_type_containing_generic_parameter() { let mut path_fork = super::PathInternerFork::empty(); let mut string_table = StringTable::new();
let (entry_path, start_name) = super::entry_path_and_start_name(&mut path_fork, &mut string_table);
...
#[test]
fn validator_rejects_function_parameter_type_containing_generic_parameter() { let mut path_fork = super::PathInternerFork::empty(); let mut string_table = StringTable::new();
let (entry_path, start_name) = super::entry_path_and_start_name(&mut path_fork, &mut string_table);
...
#[test]
fn validator_rejects_placeholder_terminator() { let mut path_fork = super::PathInternerFork::empty(); let mut string_table = StringTable::new();
let (entry_path, start_name) = super::entry_path_and_start_name(&mut path_fork, &mut string_table);
...
#[test]
fn validator_rejects_region_cycle() { let mut path_fork = super::PathInternerFork::empty(); let mut string_table = StringTable::new();
let (entry_path, start_name) = super::entry_path_and_start_name(&mut path_fork, &mut string_table);
...
#[test]
fn validator_rejects_missing_region_parent() { let mut path_fork = super::PathInternerFork::empty(); let mut string_table = StringTable::new();
let (entry_path, start_name) = super::entry_path_and_start_name(&mut path_fork, &mut string_table);
...
#[test]
fn validator_rejects_cross_function_cfg_edges() { let mut path_fork = super::PathInternerFork::empty(); let mut string_table = StringTable::new();
let (entry_path, start_name) = super::entry_path_and_start_name(&mut path_fork, &mut string_table);
...
#[test]
fn lowering_errors_preserve_string_table_context() { let mut path_fork = super::PathInternerFork::empty(); let mut string_table = StringTable::new();
let (entry_path, start_name) = super::entry_path_and_start_name(&mut path_fork, &mut string_table);
...
let messages = lower_ast(build_ast_with_registered_types(vec![start_fn], entry_path), &mut string_table, &mut path_fork)
...
#[test]
fn hir_variant_construct_option_invalid_index_rejected() { let mut path_fork = super::PathInternerFork::empty(); let mut string_table = StringTable::new();
let (entry_path, start_name) = super::entry_path_and_start_name(&mut path_fork, &mut string_table);
...
#[test]
fn hir_variant_construct_result_invalid_index_rejected() { let mut path_fork = super::PathInternerFork::empty(); let mut string_table = StringTable::new();
let (entry_path, start_name) = super::entry_path_and_start_name(&mut path_fork, &mut string_table);
...
#[test]
fn hir_variant_construct_choice_wrong_field_name_rejected() { let mut path_fork = super::PathInternerFork::empty(); let mut string_table = StringTable::new();
let (entry_path, start_name) = super::entry_path_and_start_name(&mut path_fork, &mut string_table);
...
#[test]
fn hir_variant_construct_choice_wrong_field_type_rejected() { let mut path_fork = super::PathInternerFork::empty(); let mut string_table = StringTable::new();
let (entry_path, start_name) = super::entry_path_and_start_name(&mut path_fork, &mut string_table);
let response_param = super::symbol("response", &mut path_fork, &mut string_table);
let ok_name = string_table.intern("Ok");
let err_name = string_table.intern("Err");
